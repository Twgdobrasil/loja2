<!-- PAGE -->
<section class="page-section image testimonials" style="background: url(<?php echo base_url(); ?>uploads/others/parralax_search.jpg) center top no-repeat; background-attachment:fixed; background-size:cover;padding-top: 40px;padding-bottom: 70px;">
	<div style=" background:#000';">
        <div class="container">
            <h2 class="section-title section-title-lg">
                <span>
                    <?php echo $this->db->get_where('ui_settings',array('ui_settings_id' => 27))->row()->value;?>
                </span>
            </h2>
            <?php
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="widget widget-filter-price" style="padding: 2px 20px;height: 40px;">                
                            ...
                            <input type="text" style="position: absolute; width:75%; text-align:center;margin-top: -30px;border: none;" id="amount" />
