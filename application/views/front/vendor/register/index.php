            ...
            <div class="col-sm-8 col-sm-offset-2">
                ...
                ?>
                	<div class="row box_shape">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input class="form-control required" name="horario_semana_inicio" type="text" placeholder="<?php echo 'Horário Abertura Dia de Semana (Ex: 08:00)';?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input class="form-control required" name="horario_semana_fim" type="text" placeholder="<?php echo 'Horário Fechamento Dia de Semana (Ex: 18:00)';?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input class="form-control required" name="horario_fds_inicio" type="text" placeholder="<?php echo 'Horário Abertura Fim de Semana e Feriados (Ex: 08:00)';?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input class="form-control required" name="horario_fds_fim" type="text" placeholder="<?php echo 'Horário Fechamento Fim de Semana e Feriados (Ex: 18:00)';?>">
                            </div>
                        </div>
                        <div class="col-md-12">
