    ...
    <table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true"  data-show-toggle="true" data-show-columns="true" data-search="true" >
        ...
        <?php
            ...
            foreach($all_sales as $row){
                $i++; 
        ?>
        <tr class="<?php if($row['viewed'] !== 'ok'){ echo 'Pendente'; } ?>" >
            <td><?php echo $i; ?></td>
            ...
            <td>
                ...
                <div class="label label-<?php if($dev['status'] == 'Entregue'){ ?>purple<?php } else { ?>danger<?php } ?>">
                <?php
                        if(isset($dev['vendor'])){
            ...
            <td>
                ...
                <div class="label label-<?php if($dev['status'] == 'pago'){ ?>purple<?php } else { ?>danger<?php } ?>">
                <?php
                        if(isset($dev['vendor'])){
                            echo $this->crud_model->get_type_name_by_id('vendor', $dev['vendor'], 'display_name').' ('.translate('vendor').') : '.$dev['status'];
                        } else if(isset($dev['admin'])) {
