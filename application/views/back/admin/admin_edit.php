		...
		?>
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="email" name="email" value="<?php echo $row['email']; ?>" id="demo-hor-2" class="form-control required emails" placeholder="<?php echo translate('email'); ?>" >
                ...
                <div class="col-sm-6">
                    <input type="password" name="password" value="<?php echo $row['password'];?>" id="demo-hor-3" class=" form-control required" placeholder="<?php echo translate('password'); ?>">
                </div>
            </div>
                <div class="form-group">
