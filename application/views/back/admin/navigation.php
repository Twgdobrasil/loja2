                ...
                <div class="nano-content" style="overflow-x:auto;">
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li <?php if($page_name=="coupon"){?> class="active-link" <?php } ?> >
                            <a href="<?php echo base_url(); ?>index.php/admin/vendas_report/">
                                <i class="fa fa-usd"></i>
                                    <span class="menu-title">
                                        Relatório de Vendas
                                    </span>
                        ...
                        <li <?php if($page_name=="vendor" || 
                            ...
                            <ul class="collapse <?php if($page_name=="vendor" || 
                                ...
                                <li <?php if($page_name=="creditos"){?> class="active-link" <?php } ?> >
                                    <a href="<?php echo base_url(); ?>index.php/admin/creditos">
                                        <i class="fa fa-circle fs_i"></i>
                        ...
                        <li <?php if($page_name=="propagandas"){?> class="active-link" <?php } ?> >
                            <a href="<?php echo base_url(); ?>index.php/admin/propagandas/">
                                <i class="fa fa-lock"></i>
                                <span class="menu-title">
                                    <?php echo translate('propagandas');?>
                                </span>
                            </a>
                        </li>
