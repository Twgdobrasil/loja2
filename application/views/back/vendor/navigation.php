            ...
            <div class="nano">
                <div class="nano-content">
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li <?php if($page_name=="comprar_creditos"){?> class="active-link" <?php } ?> >
                            <a href="<?php echo base_url(); ?>index.php/vendor/comprar_creditos/">
                                <i class="fa fa-gift"></i>
                                <span class="menu-title">
                                    Créditos
                                </span>
                        ...
                        <li <?php if($page_name=="clientes_favoritos"){?> class="active-link" <?php } ?> >
                            <a href="<?php echo base_url(); ?>index.php/vendor/clientes_favoritos/">
                        ...
                        <!-- <li <?php if($page_name=="lista_desejos"){?> class="active-link" <?php } ?> >
                            <a href="<?php echo base_url(); ?>index.php/vendor/lista_desejos/">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <span class="menu-title">
                                    Lista de Desejos
                                </span>
                        ...
                        <li <?php if($page_name=="chat"){?> class="active-link" <?php } ?> >
                            <a href="<?php echo base_url(); ?>index.php/vendor/chat/">
