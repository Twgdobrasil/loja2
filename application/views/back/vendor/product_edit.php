                ...
                <div class="tab-base">
                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5">Peso do Produto:</label>
                                <div class="col-sm-6">
                                    <input type="text" name="peso" id="demo-hor-5" value="" placeholder="Peso" class="form-control unit required col-sm3">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5">Largura do Produto:</label>
                                <div class="col-sm-6">
                                    <input type="text" name="largura" id="demo-hor-5" value="" placeholder="Largura" class="form-control unit required col-sm3">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5">Altura do Produto:</label>
                                <div class="col-sm-6">
                                    <input type="text" name="altura" id="demo-hor-5" value="" placeholder="Altura" class="form-control unit required col-sm3">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5">Profundidade:</label>
                                <div class="col-sm-6">
                                    <input type="text" name="comprimento" id="demo-hor-5" value="" placeholder="Profundidade" class="form-control unit required col-sm3">
                                </div>
                            </div>
                        ...
                        <div id="business_details" class="tab-pane fade">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-8">Tipo de envio:</label>
                                <div class="col-sm-4">
                                    <select class="form-control unit required">
                                        <option value="">Selecione...</option>
                                        <option value="frete_fixo">Frete Fixo</option>
                                ...
                                <div class="form-group" data-no="<?php echo $row1['no']; ?>">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="demo-chosen-select op_type required" name="op_type[]" >
                                            ...
                                            <option value="text" <?php if($row1['type'] == 'text'){ echo 'selected'; } ?> >receber o seu comentário em texto</option>
                                            <option value="single_select" <?php if($row1['type'] == 'single_select'){ echo 'selected'; } ?> >única opção para selecionar em lista</option>
                                            <option value="multi_select" <?php if($row1['type'] == 'multi_select'){ echo 'selected'; } ?> >Várias opções para selecionar por visto</option>
                                            <option value="radio" <?php if($row1['type'] == 'radio'){ echo 'selected'; } ?> >Selecionar por icone circular</option>
                                        </select>
...
<script type="text/javascript">
	...
	function get_brnd(id){
        $('#brn').hide('slow');
        ajax_load(base_url+'index.php/vendor/product/brand_by_sub/'+id,'brand','other');
        $('#brn').show('slow');
    }
    ...
    $("#more_option_btn").click(function(){
        ...
        $("#more_additional_options").append(''
            ...
            +'            <option value="text">receber o seu comentário em texto</option>'
            +'            <option value="single_select">única opção para selecionar em lista</option>'
            +'            <option value="multi_select">Várias opções para selecionar por visto</option>'
            +'            <option value="radio">Selecionar por icone circular</option>'
            +'        </select>'
            +'        <div class="col-sm-12 options">'
