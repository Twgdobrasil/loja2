...
(1, 'Mr. Master Admin', '', '', 'admin@shop.com', '8cb2237d0679ca88db6464eac60da96345513964', '1', '1476397936'),
...
ALTER TABLE banner CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE blog CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE blog_category CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE brand CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE business_settings CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE category CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE ci_sessions CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE currency_settings CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE contact_message CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE coupon CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE general_settings CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE language CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE language_list CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE logo CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE membership CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE membership_payment CONVERT TO CHARACTER SET utf8(-;-)
...
ALTER TABLE sale CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE slider CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE slider_style CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE slides CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE social_links CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE stock CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE subscribe CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE sub_category CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE ui_settings CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE user CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE ticket CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE ticket_message CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE vendor CONVERT TO CHARACTER SET utf8(-;-)
ALTER TABLE vendor_invoice CONVERT TO CHARACTER SET utf8